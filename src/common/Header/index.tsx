    ...
    >
      ...
      >
        <Logo
          logoColor={cn(
            isNotFoundPage
              ? "text-green-500 dark:text-[#00FF40]"
          ...
          <div className="button relative">
            <button
              ...
              className={cn(
                ...
                isNotFoundPage || isActive
                  ? `text-green-500 dark:hover:text-green-500 hover:text-green-500`
                  : `dark:hover:text-green-500 text-gray-300`
              )}
            >
        ...
        <button
          ...
          className={cn(
            ...
            isNotFoundPage || isActive
              ? `text-green-500 dark:hover:text-green-500 hover:text-green-500`
              : `dark:hover:text-green-500 text-secColor`
          )}
